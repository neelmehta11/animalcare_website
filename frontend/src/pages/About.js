                ...
                <div className="team-item rounded p-4">
                  ...
                  <div className="d-flex justify-content-center">
                    <a
                      ...
                      href="https://www.facebook.com/subh.dora.1/"
                      target="_blank"
                    >
                    ...
                    <a
                      className="btn btn-square btn-outline-secondary rounded-circle mx-1"
                      href="https://www.instagram.com/subh.am_dora/"
                      target="_blank"
                    >
              ...
              >
                <div className="team-item rounded p-4">
                  ...
                  <div className="d-flex justify-content-center">
                    <a
                      className="btn btn-square btn-outline-secondary rounded-circle mx-1"
                      href="https://www.facebook.com/neel.mehta.75470"
                      target="_blank"
                    >
                      <i className="fab fa-facebook-f" />
                    </a>
                    ...
                    <a
                      className="btn btn-square btn-outline-secondary rounded-circle mx-1"
                      href="https://www.instagram.com/neelmehta09/"
                      target="_blank"
                    >
                      <i className="fab fa-instagram" />
                    </a>
